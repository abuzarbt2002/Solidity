...
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        require(unlock_time <= fakenow, 'Your unlock period has not lapsed yet!');
        // 2: `distributed_shares` is less than the `total_shares`
        require(distributed_shares < total_shares, 'Your distrbution shares are more than the total numbers of shares you hold!');
